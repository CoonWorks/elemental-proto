...
function cargarInfo(xml, i) {
  ...
  document.getElementById("elementogrande").style.backgroundImage = Image(x[i].getElementsByTagName("IMAGEN1")[0].childNodes[0].nodeValue);
  document.getElementById("atomo").style.backgroundImage = Image(x[i].getElementsByTagName("IMAGEN2")[0].childNodes[0].nodeValue);
