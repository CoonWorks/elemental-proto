...
function cargarInfo(xml, i) {
  ...
  document.getElementById("elementogrande").backgroundImage = x[i].getElementsByTagName("IMAGEN1")[0].childNodes[0].nodeValue;
  document.getElementById("atomo").backgroundImage = x[i].getElementsByTagName("IMAGEN2")[0].childNodes[0].nodeValue;
