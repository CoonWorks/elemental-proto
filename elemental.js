...
function cargarInfo(xml, i) {
  ...
  document.getElementById("elementogrande").innerHTML = x[i].getElementsByTagName("IMAGEN1")[0].childNodes[0].nodeValue;
  document.getElementById("atomo").innerHTML = x[i].getElementsByTagName("IMAGEN2")[0].childNodes[0].nodeValue;
